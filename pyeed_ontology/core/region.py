...
@forge_signature
class Region(Annotation, search_mode="unordered"):
    ...
    start: Optional[int] = element(
        description=(
            "Start position in the amino acid sequence of the annotated region."
        ),
        default=None,
        tag="start",
        ...
        description=(
            "End position position in the amino acid sequence of the annotated region."
        ),
        default=None,
        tag="end",
        json_schema_extra=dict(),
